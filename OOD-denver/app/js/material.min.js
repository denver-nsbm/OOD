...
!function () {
  ...
  s = function () {
    ...
    function i(t, s) {
      if ("undefined" == typeof t && "undefined" == typeof s)for (var a = 0; a < p.length; a++)i(p[a].className, p[a].cssClass); else {
        var l = t;
    ...
    function _(e) {
      if (e && e[C].classConstructor.prototype.hasOwnProperty(u)) {
        ...
        var t = c.indexOf(e);
        c.splice(t, 1);
        var s = e.element_.getAttribute("data-upgraded").split(","), i = s.indexOf(e[C].classAsString);
    ...
    var p = [], c = [], u = "mdlDowngrade", C = "mdlComponentConfigInternal_";
    return {
      upgradeDom: i,
      upgradeElement: n,
      upgradeElements: a,
  ...
  window.MaterialIconToggle = d, d.prototype.Constant_ = {TINY_TIMEOUT: .001}, d.prototype.CssClasses_ = {
  ...
  window.MaterialRadio = p, p.prototype.Constant_ = {TINY_TIMEOUT: .001}, p.prototype.CssClasses_ = {
    IS_FOCUSED: "is-focused",
    IS_DISABLED: "is-disabled",
    IS_CHECKED: "is-checked",
    IS_UPGRADED: "is-upgraded",
  ...
  window.MaterialSwitch = C, C.prototype.Constant_ = {TINY_TIMEOUT: .001}, C.prototype.CssClasses_ = {
  ...
  window.MaterialTooltip = L, L.prototype.Constant_ = {}, L.prototype.CssClasses_ = {IS_ACTIVE: "is-active"}, L.prototype.handleMouseEnter_ = function (e) {
    e.stopPropagation();
    var t = e.target.getBoundingClientRect(), s = t.left + t.width / 2, i = -1 * (this.element_.offsetWidth / 2);
  ...
  }, s.register({constructor: I, classAsString: "MaterialLayout", cssClass: "mdl-js-layout"});
  var f = function (e) {
    this.element_ = e, this.init()
  };
    ...
    if (this.element_) {
      ...
      if (this.element_.classList.contains(this.CssClasses_.SELECTABLE)) {
        ...
        for (var n = 0; n < t.length; n++) {
          ...
          if (a) {
            var l = document.createElement("td"), o = this.createCheckbox_(t[n]);
  ...
  }, s.register({constructor: f, classAsString: "MaterialDataTable", cssClass: "mdl-js-data-table"});
  var b = function (e) {
    this.element_ = e, this.init()
  };
